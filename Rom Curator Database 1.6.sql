...
-- View to show DAT import summary with detailed statistics
...
-- View to validate SHA1 matching between DAT entries and ROM files
...
GROUP BY parent.dat_entry_id, parent.external_id, parent.release_title, parent.rom_sha1, p.name, ms.name, il.file_name
...
-- View to show overall DAT import health metrics
