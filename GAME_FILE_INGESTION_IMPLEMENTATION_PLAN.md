...
- Implement lightweight instrumentation hooks early so later work items can record timing/resource metrics without rewrites; persist throughput history for ETA estimation.
...
### Work Item 16: Library Organization & Operation Logging
